...
## 2026-09-24 — Tip of the day: Obfuscation is a tell
...
## 2026-09-25 — Tip of the day: Jailbreak names are a checklist, not the whole threat

DAN/developer-mode strings are easy to block; the real risk is novel phrasing. Layer rules with budget + human review.


## 2026-09-26 — Tip of the day: Indirect injection is the silent one
